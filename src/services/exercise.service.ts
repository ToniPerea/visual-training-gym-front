...
export class ExerciseService {
  ...
  add(exerciseData: Exercise): Observable<Exercise> {
    return this.http
      .post<IJsonObject>(
        /*'http://localhost:8080/exercise'*/ 'http://vtgym.sytes.net:8080/exercise',
  ...
  get(exerciseID: string): Observable<Exercise> {
    return this.http
      .get<IJsonObject>(
        /*`http://localhost:8080/getTraining/${exerciseID}`*/
        `http://vtgym.sytes.net:8080/getTraining/${exerciseID}`
      )
  ...
  getExercisesList(): Observable<Array<Exercise>> {
    return this.http
      .get<IJsonArray>(
        /*`http://localhost:8080/getExercisesList`*/
        `http://vtgym.sytes.net:8080/getExercisesList`
      )
  ...
  put(exerciseData: Exercise): Observable<Exercise> {
    return this.http
      .put<IJsonObject>(
        ...
        'http://vtgym.sytes.net:8080/updateExercise',
  ...
  delete(exerciseID: string): Observable<null> {
    return this.http.delete<null>(
      /*`http://localhost:8080/deleteExercise/${exerciseID}`*/
      `http://vtgym.sytes.net:8080/deleteExercise/${exerciseID}`
    );
  }
}
