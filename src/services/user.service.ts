  ...
  register(userData: User): Observable<User> {
    return this.http
      .post<IJsonObject>(
        ...
        'http://vtgym.sytes.net:8080/register',
  ...
  put(userEmail: string | null, userData: User): Observable<JwtResponse> {
    return this.http
      .put<JwtResponse>(
        ...
        `http://vtgym.sytes.net:8080/updateUser/${userEmail}`,
        Serialize(userData, () => User)
      )
      .pipe(
        tap((res: JwtResponse) => {
  ...
  get(userEmail: string): Observable<User> {
    return (
      this.http
        ...
        .get<IJsonObject>(`http://vtgym.sytes.net:8080/getUserByEmail/${userEmail}`)
  ...
  getUsersList(): Observable<Array<User>> {
    return (
      this.http
        ...
        .get<IJsonArray>(`http://vtgym.sytes.net:8080/getUsersList`)
